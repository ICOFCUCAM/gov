...
export async function substrateSearch(query: string): Promise<SearchHit[]> {
  ...
  const hits: SearchHit[] = [
    ...
    ...ds.map(r => ({ kind: 'dispatch' as const, id: r.id, ref: r.ref,
      ...
      href: '/gov/dispatches', at: new Date(r.dispatched_at).getTime() })),
