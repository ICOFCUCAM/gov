  ...
  return (
    <div className="space-y-2 font-mono">
      <div className="flex flex-wrap items-center gap-x-4 gap-y-1 border-y px-3 py-2 text-[11px]"
        ...
        <span className="ml-auto text-[9px] text-ink-muted">alerts {o.alerts} · warns {o.warns} · safeguard sets {o.safeguardSetCount} · prohibited {o.totalProhibitedCount}</span>
      </div>
