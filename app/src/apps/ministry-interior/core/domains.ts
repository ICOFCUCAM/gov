...
export type SurfaceId =
  ...
  | 'national-stability-command' | 'interior-command-theater' | 'event-propagation' | 'operational-timeline';
...
export const DOMAINS: InteriorDomain[] = [
  ...
  { key: 'interior-command-theater', label: 'Command Theater', group: 'command', accent: '#e0a23a', archetype: 'ops', surface: 'interior-command-theater', federation: null, identity: 'Tactical national event stream — incident pulse, regional sectors, escalation rail' },
  { key: 'event-propagation', label: 'Event Propagation', group: 'command', accent: '#e0673a', archetype: 'fabric', surface: 'event-propagation', federation: null, identity: 'Inter-ministry cascade — sovereign event orchestration' },
  { key: 'operational-timeline', label: 'Operational Timeline', group: 'command', accent: '#e0a23a', archetype: 'registry', surface: 'operational-timeline', federation: null, identity: 'Persistent incident memory across operational epochs' },
  ...
  { key: 'ministry-character', label: 'Ministry Character Registry', group: 'infra', accent: '#8a7df0', archetype: 'governance', surface: 'ministry-character', federation: null, identity: 'Formal sovereign identity per Tier-1 ministry shell' },
];
